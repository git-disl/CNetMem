...
typedef struct cnetmem_mempool_s {
	spinlock_t lock;
	spinlock_t slock;
	spinlock_t rlock;
	spinlock_t flock;
...
//static cnetmem_mempool_t *cnetmem_page_pool = NULL;
static cnetmem_mempool_t cnetmem_page_pool;

extern int mempool_init();
//extern cnetmem_mempool_t *cnetmem_mempool_create(int cap_nr);
extern int cnetmem_mempool_create(cnetmem_mempool_t *pool, long cap_nr);
extern int cnetmem_mempool_resize(cnetmem_mempool_t *pool, long new_cap_nr);
extern void cnetmem_mempool_destroy(cnetmem_mempool_t *pool);

extern void * cnetmem_mempool_alloc(cnetmem_mempool_t *pool);
extern void cnetmem_mempool_free(void *element, cnetmem_mempool_t *pool);
extern void * cnetmem_alloc();
extern void cnetmem_free(void *element);

extern void * cnetmem_mempool_reclaim(cnetmem_mempool_t *pool);
